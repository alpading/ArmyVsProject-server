...
router.get(
    ...
    asyncHandler(async (req, res) => {
        ...
        const selectElemByRankResult = await pool.query(
            selectElemByRankQuery,
            selectElemByRankParams
        )
...
router.get(
    ...
    LIMIT
        ...
        const selectRandomElemListResult = await pool.query(
            selectRandomElemListQuery,
            selectRandomElemListParams
        )
...
router.put(
    ...
    asyncHandler(async (req, res) => {
        ...
        const selectElemWinCountResult = await pool.query(
            selectElemWinCountQuery,
            selectElemWinCountParams
        )
